...
namespace Conflow
{
    public partial class Pesquisa_ProprietarioUC : UserControl
    {
        public Pesquisa_ProprietarioUC()
        {
            InitializeComponent();
                ...
                try
                {
                    ...
                    switch (filtroTipoCoB.Text)
                    {
                        ...
                        case "Nome":
                            ...
                            cmdSelect += "WHERE PRO.NOME_PROPRIETARIO LIKE @nome; ";
                        ...
                        case "RG":
                            cmdSelect += "WHERE PRO.RG_PROPRIETARIO = @rg;";
                            rgTbox.TextMaskFormat = MaskFormat.ExcludePromptAndLiterals;
                        ...
                        case "CPF":
                            cmdSelect += "WHERE CPF.CPF_PROPRIETARIO = @cpf;";

                            cmd.Parameters.AddWithValue("cpf", filtroValorTbox.Text);
                            break;

                        case "CNPJ":
                            cmdSelect += "WHERE CNPJ.CNPJ_PROPRIETARIO = @cnpj;";
